    ...
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="#" class="b-brand text-primary">
                ...
                <img src="/assets/images/saosao_logo.png" alt="SaoSao" style="width:50px"/>
    ...
    <div class="header-wrapper"> <!-- [Mobile Media Block] start -->
        ...
        <div class="ms-auto">
            <ul class="list-unstyled">
                ...
                <li class="dropdown pc-h-item">
                    <a href="https://github.com/hosseinabdinasab/SaoSao-Panel" target="_blank">
                        <img alt="GitHub Repo stars" src="https://img.shields.io/github/stars/hosseinabdinasab/SaoSao-Panel?style=social&link=left">
                    </a>
                </li>
                <li class="dropdown pc-h-item">
                    <a href="https://plisio.net/donate/aM0zuLeX" target="_blank"><span class="badge bg-light-primary rounded-pill f-12"><i class="fas fa-donate"></i>&nbsp;{{__('donate')}}</span></a>
                </li>
                <li class="dropdown pc-h-item">
