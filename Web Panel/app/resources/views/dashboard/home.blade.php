...
@section('title','SaoSao - '.__('dashboard-title'))
@section('content')
        ...
        <div class="pc-content">
            ...
            <div class="row">
                @if(env('APP_LOCALE') == 'fa')
                    @php
                        $json = file_get_contents('https://raw.githubusercontent.com/hosseinabdinasab/SaoSao-Panel/master/version.json');
                        $obj = json_decode($json);
                        $github='https://github.com/hosseinabdinasab/SaoSao-Panel/blob/master/README.md#installation-guide';
                    @endphp
                @elseif(env('APP_LOCALE') == 'en')
                    @php
                        $json = file_get_contents('https://raw.githubusercontent.com/hosseinabdinasab/SaoSao-Panel/master/version.json');
                        $obj = json_decode($json);
                        $github='https://github.com/hosseinabdinasab/SaoSao-Panel/blob/master/README-EN.md#installation-guide';
                    @endphp
                @elseif(env('APP_LOCALE') == 'ru')
                    @php
                        $json = file_get_contents('https://raw.githubusercontent.com/hosseinabdinasab/SaoSao-Panel/master/version.json');
                        $obj = json_decode($json);
                        $github='https://github.com/hosseinabdinasab/SaoSao-Panel/blob/master/README-RU.md#installation-guide';
                    @endphp
                @endif
