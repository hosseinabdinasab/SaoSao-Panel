...
class SettingsController extends Controller
{
    ...
    public function index(Request $request,$name)
    {
        ...
        if($name=='license') {
            ...
            if($license) {
                ...
                $ch = curl_init('https://saosao.pro/api/license/validate');
                curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    ...
    public function restore_backup(Request $request,$name)
    {
        ...
        Process::run("mysql -u '" . env('DB_USERNAME') . "' --password='" . env('DB_PASSWORD') . "' SaoSao_plus < /var/www/html/app/storage/backup/" . $name);
    ...
    public function make_backup()
    {
        ...
        Process::run("mysqldump -u '" .env('DB_USERNAME'). "' --password='" .env('DB_PASSWORD'). "' SaoSao_plus > /var/www/html/app/storage/backup/SaoSao-".$date.".sql");
        return redirect()->intended(route('settings', ['name' => 'backup']));
    }
